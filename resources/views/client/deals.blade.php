            ...
            <div class="relative bg-white">
                <div class="lg:absolute lg:inset-0">
                    <div class="lg:absolute lg:inset-y-0 lg:left-0 lg:w-1/2">
                        <img class="h-56 w-full object-contain lg:absolute lg:h-full" src="{{asset('images/deals.jpg')}}" alt="">
                    </div>
                </div>
                <div class="relative pt-12 pb-16 px-4 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
                    <div class="lg:col-start-2 lg:pl-8">
                        <div class="text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
                            ...
                            <h4 class="leading-7 mt-8 text-blue-600 font-semibold tracking-wide uppercase">Помощь техническими средствами реабилитации</h4>
                            ...
                            <h4 class="leading-7 mt-8 text-blue-600 font-semibold tracking-wide uppercase">Формируем толерантное отношение общества</h4>
